...
Slides: [talks.gustavodiaz.org/nu](https://talks.gustavodiaz.org/nu.html)
...
- [Confidentiality protocols]{style="color: gray;"} 
...
## But variance reduction is not free {visibility="uncounted"}
...
- Positive correlation across lists [(Glynn 2013)](https://doi.org/10.1093/poq/nfs070)
...
## Criminal governance tools in Uruguay {visibility="uncounted"}
...
::: aside
Looks the same for the other sensitive items!
:::
...
- **Goal:** Use tests to rule out *strategic errors*
...
## To estimate bounds {visibility="uncounted"}
...
<!-- CONTINUE HERE FOR NORTHWESTERN THE MAIN LESSON IS THAT NEW TOOLS COME WITH HIDDEN COSTS. NO FREE LUNCH. MANY TECHNIQUES PROMISE IMPROVING ALONG THE BIAS-VARIANCE FRONTIER. -->
