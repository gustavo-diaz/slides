...
- [Alvarez et al (2019) details](#alvarez)
- [Montevideo survey responses](#mvd)
- [Signed rank test](#steph)
- DLE cost simulations
- Performance simulations
- Placebo tests
- More bounds
- Network scale-up

## [Alvarez et al (2019)](https://doi.org/10.1017/pan.2018.57) details {#alvarez visibility="uncounted"}
...
## Applied to [Alvarez et al (2019)](https://doi.org/10.1017/pan.2018.57)
