...
library(kableExtra)
library(docxtools) # scientific notation
...
::: aside
This is work in progres with [Ines Fynn](https://uy.linkedin.com/in/ines-fynn-8b07733b), [Verónica Pérez Bentancur](https://cienciassociales.edu.uy/departamento-de-ciencia-politica/veronica-perez-bentancur/), and [Lucía Tiscornia](https://www.luciatiscornia.com/)
:::
...
ggplot(bounds) +
  aes(x = pi, y = hi) +
  geom_ribbon(aes(ymin = lo, ymax = hi), fill = "#00b176", alpha = 0) +
  geom_line(linetype = "dashed", linewidth = 1, alpha = 0) +
  geom_line(aes(y = lo), linetype = "dashed", linewidth = 1, alpha = 0) +
  geom_hline(yintercept = direct, linetype = "dotted", alpha = 0) +
  geom_vline(xintercept = 0.5, linetype = "dotted", alpha = 0) +
...
ggplot(bounds) +
  ...
  geom_line(linetype = "dashed", linewidth = 1, alpha = 0) +
  geom_line(aes(y = lo), linetype = "dashed", linewidth = 1, alpha = 0) +
  geom_hline(yintercept = direct, linetype = "dotted") +
...
ggplot(bounds) +
  aes(x = pi, y = hi) +
  geom_ribbon(aes(ymin = lo, ymax = hi), fill = "#00b176") +
  geom_line(linetype = "dashed", linewidth = 1) +
  geom_line(aes(y = lo), linetype = "dashed", linewidth = 1) +
  geom_hline(yintercept = direct, linetype = "dotted") +
  geom_vline(xintercept = 0.5, linetype = "dotted") +
  annotate("text", x = 0.018, y = direct + 0.03, label = "Direct question") +
  annotate("text", x = 0.56, y = 0.9, label = "Unrealistic") +
